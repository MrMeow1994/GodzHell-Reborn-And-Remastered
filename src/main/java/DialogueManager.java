...
public class DialogueManager {
	...
	public static void sendTimedPlayerChat(client player, Emotion emotion, String... lines) {
		...
		case 1:
			...
			player.getPA().sendFrame126(player.playerName, 12775);
		...
		case 2:
			...
			player.getPA().sendFrame126(player.playerName, 12779);
		...
		case 3:
			...
			player.getPA().sendFrame126(player.playerName, 12784);
		...
		case 4:
			...
			player.getPA().sendFrame126(player.playerName, 11886);
