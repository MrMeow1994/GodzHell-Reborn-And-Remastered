...
public final class RequestDispatcher {
	 ...
	 */
	private static final int MAXIMUM_QUEUE_SIZE = 4096;

	/**
	 * A queue for pending 'on-demand' requests.
	 */
	private static final BlockingQueue<ChannelRequest<OnDemandRequest>> onDemandQueue =
			new PriorityBlockingQueue<>();

	/**
	 * A queue for pending JAGGRAB requests.
	 */
	private static final BlockingQueue<ChannelRequest<JagGrabRequest>> jagGrabQueue =
			new LinkedBlockingQueue<>();

	/**
	 * A queue for pending HTTP requests.
	 */
	private static final BlockingQueue<ChannelRequest<HttpRequest>> httpQueue =
			new LinkedBlockingQueue<>();
