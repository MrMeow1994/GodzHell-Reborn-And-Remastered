public class SummoningPouch {
    ...
    public static void makePouch(client c, int actionButtonId) {
        int POUCH = 12155;
        ...
        switch (actionButtonId) {
            ...
            case 91184: // START OF SUMMONING POUCHES // Wolf
                ...
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(12158, 1) && c.playerHasItem(2859, 1) && c.playerHasItem(12155, 1) && c.playerHasItem(18016, 7) && c.playerLevel[c.playerSummoning] >= 1) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(2000, c.playerSummoning);
                        //c.sendMessage("You created ; Spirit Wolf Pouch");
                        c.deleteItem(2859, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 7);
                        c.deleteItem(GCHARM, 1);
                        c.addItem(12047, 1);
                    } else {
                        if (c.hasSentMessage) {
                            return;
            ...
            case 91192: // Dreadfowl chicken pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(12158, 1) && c.playerHasItem(2138, 1) && c.playerHasItem(12155, 1) && c.playerHasItem(18016, 8) && c.playerLevel[c.playerSummoning] >= 4) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(4000, c.playerSummoning);
                        //c.sendMessage("You created ; DreadFowl Pouch");
                        c.deleteItem(2138, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 8);
                        c.deleteItem(GCHARM, 1);
                        c.addItem(12043, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 91200: // spirit spider pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(12158, 1) && c.playerHasItem(6291, 1) && c.playerHasItem(12155, 1) && c.playerHasItem(18016, 8) && c.playerLevel[c.playerSummoning] >= 10) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(7000, c.playerSummoning);
            ...
            case 91208: // thorny snail
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(12158, 1) && c.playerHasItem(3369, 1) && c.playerHasItem(12155, 1) && c.playerHasItem(18016, 9) && c.playerLevel[c.playerSummoning] >= 13) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(9000, c.playerSummoning);
                        //c.sendMessage("You created ; Thorny Snail Pouch");
                        c.deleteItem(3369, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 9);
                        c.deleteItem(GCHARM, 1);
                        c.addItem(12019, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 91216: // Granite crab
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(12158, 1) && c.playerHasItem(440, 1) && c.playerHasItem(12155, 1) && c.playerHasItem(18016, 7) && c.playerLevel[c.playerSummoning] >= 16) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(10000, c.playerSummoning);
            ...
            case 91224: // Mosquito
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(12158, 1) && c.playerHasItem(6319, 1) && c.playerHasItem(12155, 1) && c.playerHasItem(18016, 20) && c.playerLevel[c.playerSummoning] >= 17) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(10500, c.playerSummoning);
                        //c.sendMessage("You created ; Mosquito Pouch");
                        c.deleteItem(6319, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 20);
                        c.deleteItem(GCHARM, 1);
                        c.addItem(12778, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 91232: // Desert Wyrm
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(GRCHARM, 1) && c.playerHasItem(1783, 1) && c.playerHasItem(12155, 1) && c.playerHasItem(18016, 45) && c.playerLevel[c.playerSummoning] >= 18) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(11300, c.playerSummoning);
                        //c.sendMessage("You created ; Desert Wyrm Pouch");
                        c.deleteItem(1783, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 45);
                        c.deleteItem(GRCHARM, 1);
                        c.addItem(12049, 1);
                    } else {
                        if (c.hasSentMessage) {
                            return;
            ...
            case 91240: // Spirit Scorpion
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(CCHARM, 1) && c.playerHasItem(3095, 1) && c.playerHasItem(12155, 1) && c.playerHasItem(18016, 57) && c.playerLevel[c.playerSummoning] >= 19) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(12000, c.playerSummoning);
                        //c.sendMessage("You created ; Spirit Scorpion Pouch");
                        c.deleteItem(3095, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 57);
                        c.deleteItem(CCHARM, 1);
                        c.addItem(12055, 1);
                    } else {
                        if (c.hasSentMessage) {
                            return;
            ...
            case 91248: // Spirit tz-kih pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(CCHARM, 1) && c.playerHasItem(12168, 1) && c.playerHasItem(12155, 1) && c.playerHasItem(18016, 64) && c.playerLevel[c.playerSummoning] >= 22) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(13000, c.playerSummoning);
                        //c.sendMessage("You created ; Spirit Tz-kih Pouch");
                        c.deleteItem(12168, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 64);
                        c.deleteItem(CCHARM, 1);
                        c.addItem(12808, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 92000: // Albino Rat pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(CCHARM, 1) && c.playerHasItem(12168, 1) && c.playerHasItem(12155, 1) && c.playerHasItem(18016, 64) && c.playerLevel[c.playerSummoning] >= 23) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(14300, c.playerSummoning);
            ...
            case 92008: // Spirit Kalphite
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(BCHARM, 1) && c.playerHasItem(3138, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 51) && c.playerLevel[c.playerSummoning] >= 25) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(16000, c.playerSummoning);
                        //c.sendMessage("You created ; Spirit Kalphite Pouch");
                        c.deleteItem(3138, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 51);
                        c.deleteItem(BCHARM, 1);
                        c.addItem(12063, 1);
                    } else {
                        if (c.hasSentMessage) {
                            return;
            ...
            case 92016: // Compost Mound
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(GCHARM, 1) && c.playerHasItem(6032, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 47) && c.playerLevel[c.playerSummoning] >= 28) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(13200, c.playerSummoning);
                        //c.sendMessage("You created ; Compost Mound Pouch");
                        c.deleteItem(6032, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 47);
                        c.deleteItem(GCHARM, 1);
                        c.addItem(12091, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 92024: // Giant ChinChompa Pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(BCHARM, 1) && c.playerHasItem(9976, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 84) && c.playerLevel[c.playerSummoning] >= 29) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(16600, c.playerSummoning);
                        //c.sendMessage("You created ; Giant Chinchompa Pouch");
                        c.deleteItem(9976, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 84);
                        c.deleteItem(BCHARM, 1);
                        c.addItem(12091, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 92032: // Vampire Bat Pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(CCHARM, 1) && c.playerHasItem(3325, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 81) && c.playerLevel[c.playerSummoning] >= 31) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(14000, c.playerSummoning);
                        //c.sendMessage("You created ; Vampire Bat Pouch");
                        c.deleteItem(3325, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 81);
                        c.deleteItem(CCHARM, 1);
                        c.addItem(12053, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 92040: // Honey Badger Pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(CCHARM, 1) && c.playerHasItem(12156, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 84) && c.playerLevel[c.playerSummoning] >= 32) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(14200, c.playerSummoning);
                        //c.sendMessage("You created ; Honey Badger Pouch");
                        c.deleteItem(12156, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 84);
                        c.deleteItem(CCHARM, 1);
                        c.addItem(12065, 1);
            ...
            case 92048: // Beaver Pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(GCHARM, 1) && c.playerHasItem(1519, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 72) && c.playerLevel[c.playerSummoning] >= 33) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(14000, c.playerSummoning);
            ...
            case 92056: // Void ravager
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(GCHARM, 1) && c.playerHasItem(12164, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 74) && c.playerLevel[c.playerSummoning] >= 34) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(14200, c.playerSummoning);
                        //c.sendMessage("You created ; Void Ravager Pouch");
                        c.deleteItem(12164, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 74);
                        c.deleteItem(GCHARM, 1);
                        c.addItem(12818, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 92064: // Void Spinner pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(BCHARM, 1) && c.playerHasItem(12166, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 74) && c.playerLevel[c.playerSummoning] >= 34) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(14200, c.playerSummoning);
                        //c.sendMessage("You created ; Void Spinner Pouch");
                        c.deleteItem(12166, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 74);
                        c.deleteItem(BCHARM, 1);
                        c.addItem(12780, 1);
            ...
            case 92072: //Void torcher pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(BCHARM, 1) && c.playerHasItem(12167, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 74) && c.playerLevel[c.playerSummoning] >= 34) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(14200, c.playerSummoning);
                        //c.sendMessage("You created ; Void Torcher Pouch");
                        c.deleteItem(12167, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 74);
                        c.deleteItem(BCHARM, 1);
                        c.addItem(12798, 1);
            ...
            case 92080: //Void Shifter pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(BCHARM, 1) && c.playerHasItem(12165, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 74) && c.playerLevel[c.playerSummoning] >= 34) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(14200, c.playerSummoning);
                        //c.sendMessage("You created ; Void Shifter Pouch");
                        c.deleteItem(12165, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 74);
                        c.deleteItem(BCHARM, 1);
                        c.addItem(12814, 1);
            ...
            case 92088: //Bronze minotaur
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(BCHARM, 1) && c.playerHasItem(2349, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 102) && c.playerLevel[c.playerSummoning] >= 36) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(16900, c.playerSummoning);
                        //c.sendMessage("You created ; Bronze Minotaur Pouch");
                        c.deleteItem(2349, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 102);
                        c.deleteItem(BCHARM, 1);
                        c.addItem(12073, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 92096: //Bull ant
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(GCHARM, 1) && c.playerHasItem(6010, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 11) && c.playerLevel[c.playerSummoning] >= 40) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(14600, c.playerSummoning);
                        //c.sendMessage("You created ; Bull ant Pouch");
                        c.deleteItem(6010, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 11);
                        c.deleteItem(GCHARM, 1);
                        c.addItem(12073, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 92104: //Macaw
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(GRCHARM, 1) && c.playerHasItem(249, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 78) && c.playerLevel[c.playerSummoning] >= 41) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(15300, c.playerSummoning);
                        //c.sendMessage("You created ; Macaw Pouch");
                        c.deleteItem(249, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 78);
                        c.deleteItem(GRCHARM, 1);
                        c.addItem(12071, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 92112: //Macaw
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(CCHARM, 1) && c.playerHasItem(12153, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 104) && c.playerLevel[c.playerSummoning] >= 42) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(15900, c.playerSummoning);
                        //c.sendMessage("You created ; Macaw Pouch");
                        c.deleteItem(12153, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 104);
                        c.deleteItem(CCHARM, 1);
                        c.addItem(12051, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 92176: //Iron minotaur
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(BCHARM, 1) && c.playerHasItem(2351, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 125) && c.playerLevel[c.playerSummoning] >= 46) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(18300, c.playerSummoning);
                        //c.sendMessage("You created ; Iron minotaur Pouch");
                        c.deleteItem(2351, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 125);
                        c.deleteItem(BCHARM, 1);
                        c.addItem(12075, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 92184: //pyrelord
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(CCHARM, 1) && c.playerHasItem(590, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 111) && c.playerLevel[c.playerSummoning] >= 46) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(16500, c.playerSummoning);
                        //c.sendMessage("You created ; PyreLord Pouch");
                        c.deleteItem(590, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 111);
                        c.deleteItem(CCHARM, 1);
                        c.addItem(12816, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 92192: //Magpie
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(GCHARM, 1) && c.playerHasItem(1635, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 88) && c.playerLevel[c.playerSummoning] >= 47) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(15500, c.playerSummoning);
                        //c.sendMessage("You created ; Magipie Pouch");
                        c.deleteItem(1635, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 88);
                        c.deleteItem(GCHARM, 1);
                        c.addItem(12041, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 92200: //Bloated Leech Pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(CCHARM, 1) && c.playerHasItem(2132, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 117) && c.playerLevel[c.playerSummoning] >= 49) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(17500, c.playerSummoning);
                        //c.sendMessage("You created ; Bloated Leech Pouch");
                        c.deleteItem(2132, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 117);
                        c.deleteItem(CCHARM, 1);
                        c.addItem(12061, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 92208: //Spirit terrorbird
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(GCHARM, 1) && c.playerHasItem(9978, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 12) && c.playerLevel[c.playerSummoning] >= 52) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(16300, c.playerSummoning);
                        //c.sendMessage("You created ; Spirit Terrorbird Pouch");
                        c.deleteItem(9978, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 12);
                        c.deleteItem(GCHARM, 1);
                        c.addItem(12007, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 92216: //Abbysal parasite
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(GRCHARM, 1) && c.playerHasItem(12161, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 106) && c.playerLevel[c.playerSummoning] >= 54) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(16000, c.playerSummoning);
                        //c.sendMessage("You created ; Abyssal Parasite Pouch");
                        c.deleteItem(12161, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 106);
                        c.deleteItem(GRCHARM, 1);
                        c.addItem(12035, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 92224: // Spirit Jelly
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(BCHARM, 1) && c.playerHasItem(1937, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 151) && c.playerLevel[c.playerSummoning] >= 55) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(18700, c.playerSummoning);
                        //c.sendMessage("You created ; Spirit Jelly Pouch");
                        c.deleteItem(1937, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 151);
                        c.deleteItem(BCHARM, 1);
                        c.addItem(12027, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 92232: // Steel minotaur pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(BCHARM, 1) && c.playerHasItem(2353, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 141) && c.playerLevel[c.playerSummoning] >= 56) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(19200, c.playerSummoning);
                        //c.sendMessage("You created ; Steel Minotaur Pouch");
                        c.deleteItem(2353, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 141);
                        c.deleteItem(BCHARM, 1);
                        c.addItem(12077, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 92240: // Ibis pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(GRCHARM, 1) && c.playerHasItem(311, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 109) && c.playerLevel[c.playerSummoning] >= 56) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(17500, c.playerSummoning);
            ...
            case 92248: // Spirit Graahk pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(BCHARM, 1) && c.playerHasItem(10099, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 154) && c.playerLevel[c.playerSummoning] >= 57) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(19400, c.playerSummoning);
                        //c.sendMessage("You created ; Spirit Graahk Pouch");
                        c.deleteItem(10099, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 154);
                        c.deleteItem(BCHARM, 1);
                        c.addItem(12810, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 93000: // Spirit Kyatt pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(BCHARM, 1) && c.playerHasItem(10103, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 153) && c.playerLevel[c.playerSummoning] >= 57) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(19400, c.playerSummoning);
                        //c.sendMessage("You created ; Spirit Kyatt Pouch");
                        c.deleteItem(10103, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 153);
                        c.deleteItem(BCHARM, 1);
                        c.addItem(12812, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 93008: // Spirit  larupia pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(BCHARM, 1) && c.playerHasItem(10095, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 155) && c.playerLevel[c.playerSummoning] >= 57) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(19400, c.playerSummoning);
                        //c.sendMessage("You created ; Spirit Larupia Pouch");
                        c.deleteItem(10095, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 155);
                        c.deleteItem(BCHARM, 1);
                        c.addItem(12784, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 93016: // Spirit Karamthulhu overlord pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(BCHARM, 1) && c.playerHasItem(6723, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 144) && c.playerLevel[c.playerSummoning] >= 58) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(19700, c.playerSummoning);
                        //c.sendMessage("You created ; Karamthulhu Overlord Pouch");
                        c.deleteItem(6723, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 144);
                        c.deleteItem(BCHARM, 1);
                        c.addItem(12023, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 93024: //  Smoke devil pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(CCHARM, 1) && c.playerHasItem(9736, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 141) && c.playerLevel[c.playerSummoning] >= 61) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(18300, c.playerSummoning);
            ...
            case 93032: //  abyssal lurker
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(GCHARM, 1) && c.playerHasItem(12161, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 119) && c.playerLevel[c.playerSummoning] >= 62) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(17200, c.playerSummoning);
                        //c.sendMessage("You created ; Abyssal lurker Pouch");
                        c.deleteItem(12161, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 119);
                        c.deleteItem(GCHARM, 1);
                        c.addItem(12037, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 93040: //  Spirit Cobra
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(CCHARM, 1) && c.playerHasItem(7801, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 116) && c.playerLevel[c.playerSummoning] >= 63) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(18900, c.playerSummoning);
                        //c.sendMessage("You created ; Spirit Cobra Pouch");
                        c.deleteItem(7801, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 116);
                        c.deleteItem(CCHARM, 1);
                        c.addItem(12015, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 93048: //  Stranger Plant pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(CCHARM, 1) && c.playerHasItem(8431, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 128) && c.playerLevel[c.playerSummoning] >= 64) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(19100, c.playerSummoning);
                        //c.sendMessage("You created ; Stranger plant Pouch");
                        c.deleteItem(8431, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 128);
                        c.deleteItem(CCHARM, 1);
                        c.addItem(12045, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 93056: //  Mithril Minotaur
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(BCHARM, 1) && c.playerHasItem(2359, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 152) && c.playerLevel[c.playerSummoning] >= 66) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(20100, c.playerSummoning);
                        //c.sendMessage("You created ; Mithril Minotaur Pouch");
                        c.deleteItem(2359, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 152);
                        c.deleteItem(BCHARM, 1);
                        c.addItem(12079, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 93064: // Barker toad pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(GCHARM, 1) && c.playerHasItem(2150, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 11) && c.playerLevel[c.playerSummoning] >= 66) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(18900, c.playerSummoning);
            ...
            case 93072: // Spirit War tortoise
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(GCHARM, 1) && c.playerHasItem(7939, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 131) && c.playerLevel[c.playerSummoning] >= 67) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(19000, c.playerSummoning);
                        //c.sendMessage("You created ; War Tortoise Pouch");
                        c.deleteItem(7939, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 131);
                        c.deleteItem(GCHARM, 1);
                        c.addItem(12031, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 93080: // Bunyip
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(GRCHARM, 1) && c.playerHasItem(383, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 110) && c.playerLevel[c.playerSummoning] >= 68) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(19800, c.playerSummoning);
                        //c.sendMessage("You created ; Bunyip Pouch");
                        c.deleteItem(383, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 110);
                        c.deleteItem(GRCHARM, 1);
                        c.addItem(12029, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 93088: // Fruit Bat
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(GRCHARM, 1) && c.playerHasItem(1963, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 130) && c.playerLevel[c.playerSummoning] >= 69) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(19500, c.playerSummoning);
                        //c.sendMessage("You created ; Fruit Bat Pouch");
                        c.deleteItem(1963, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 130);
                        c.deleteItem(GRCHARM, 1);
                        c.addItem(12033, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 93096: // Ravenous Locust
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(CCHARM, 1) && c.playerHasItem(1933, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 79) && c.playerLevel[c.playerSummoning] >= 70) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(19900, c.playerSummoning);
                        //c.sendMessage("You created ; Ravenous Locust Pouch");
                        c.deleteItem(1933, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 79);
                        c.deleteItem(CCHARM, 1);
                        c.addItem(12820, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 93104: // Arctic bear
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(GCHARM, 1) && c.playerHasItem(10117, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 80) && c.playerLevel[c.playerSummoning] >= 71) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(19900, c.playerSummoning);
                        //c.sendMessage("You created ; Arctic Bear Pouch");
                        c.deleteItem(10117, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 80);
                        c.deleteItem(GCHARM, 1);
                        c.addItem(12057, 1);
                    } else {
                        if (c.hasSentMessage) {
			...
			/*c.hasSentMessage = false;
			for (int i = 0; i < summoningPouchData.length; i++) {	
				if (c.playerHasItem(CCHARM, 1) && c.playerHasItem(14616, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 165) && c.playerLevel[c.playerSummoning] >= 72) {
				//c.closeAllWindows();
				c.gfx0(2128);
				c.addSkillXP(summoningPouchData[i][4]) * 900, c.playerSummoning);
				//c.sendMessage("You created ; Phoenix Pouch");
				c.deleteItem(14616, 1);
				 c.deleteItem(POUCH, 1);
				 c.deleteItem(SHARD, 165);
				 c.deleteItem(CCHARM, 1);
				 c.addItem(14623, 1);
				} else {
            ...
            case 93120: //Obsidian Golem Pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(BCHARM, 1) && c.playerHasItem(12168, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 195) && c.playerLevel[c.playerSummoning] >= 73) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(20900, c.playerSummoning);
                        //c.sendMessage("You created ; Obsidian Golem Pouch");
                        c.deleteItem(12168, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 195);
                        c.deleteItem(BCHARM, 1);
                        c.addItem(12792, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 93128: //Granite Lobster Pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(CCHARM, 1) && c.playerHasItem(6979, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 166) && c.playerLevel[c.playerSummoning] >= 74) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(21100, c.playerSummoning);
                        //c.sendMessage("You created ; Granite Lobster Pouch");
                        c.deleteItem(6979, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 166);
                        c.deleteItem(CCHARM, 1);
                        c.addItem(20500, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 93136: //Praying mantis pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(CCHARM, 1) && c.playerHasItem(2460, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 168) && c.playerLevel[c.playerSummoning] >= 75) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(21250, c.playerSummoning);
                        //c.sendMessage("You created ; Praying Mantis Pouch");
                        c.deleteItem(2460, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 168);
                        c.deleteItem(CCHARM, 1);
                        c.addItem(12011, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 93144: //Adamant Minotaur pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(BCHARM, 1) && c.playerHasItem(2361, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 144) && c.playerLevel[c.playerSummoning] >= 76) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(22200, c.playerSummoning);
            ...
            case 93152: //Forge Regent pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(GRCHARM, 1) && c.playerHasItem(10020, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 141) && c.playerLevel[c.playerSummoning] >= 76) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(21000, c.playerSummoning);
                        //c.sendMessage("You created ; Forge Regent Pouch");
                        c.deleteItem(10020, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 141);
                        c.deleteItem(GRCHARM, 1);
                        c.addItem(12782, 1);
            ...
            case 93160: //Talon Beast pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(CCHARM, 1) && c.playerHasItem(12162, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 174) && c.playerLevel[c.playerSummoning] >= 77) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(22000, c.playerSummoning);
                        //c.sendMessage("You created ; Talon Beast Pouch");
                        c.deleteItem(12162, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 174);
                        c.deleteItem(CCHARM, 1);
                        c.addItem(12794, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 93168: //Giant ent Pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(GRCHARM, 1) && c.playerHasItem(5933, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 124) && c.playerLevel[c.playerSummoning] >= 78) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(21500, c.playerSummoning);
                        //c.sendMessage("You created ; Giant Ent Pouch");
                        c.deleteItem(5933, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 124);
                        c.deleteItem(GRCHARM, 1);
                        c.addItem(12013, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 93176: //Fire Titan Pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(BCHARM, 1) && c.playerHasItem(1442, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 198) && c.playerLevel[c.playerSummoning] >= 79) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(22900, c.playerSummoning);
                        //c.sendMessage("You created ; Fire Titan Pouch");
                        c.deleteItem(1442, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 198);
                        c.deleteItem(BCHARM, 1);
                        c.addItem(12802, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 93184: //Moss Titan Pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(BCHARM, 1) && c.playerHasItem(1440, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 198) && c.playerLevel[c.playerSummoning] >= 79) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(23100, c.playerSummoning);
            ...
            case 93192: //Ice Titan Pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(BCHARM, 1) && c.playerHasItem(1444, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 198) && c.playerLevel[c.playerSummoning] >= 79) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(23100, c.playerSummoning);
            ...
            case 93200: //Hyda pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(GRCHARM, 1) && c.playerHasItem(571, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 128) && c.playerLevel[c.playerSummoning] >= 80) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(22100, c.playerSummoning);
            ...
            case 93208: //spirit dagannoth
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(CCHARM, 1) && c.playerHasItem(6155, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 122) && c.playerLevel[c.playerSummoning] >= 83) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(22900, c.playerSummoning);
            ...
            case 93216: //Lava Titan pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(BCHARM, 1) && c.playerHasItem(12168, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 219) && c.playerLevel[c.playerSummoning] >= 83) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(23500, c.playerSummoning);
                        //c.sendMessage("You created ; Lava Titan Pouch");
                        c.deleteItem(12168, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 219);
                        c.deleteItem(BCHARM, 1);
                        c.addItem(12788, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 93224: //Swamp Titan pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(BCHARM, 1) && c.playerHasItem(10149, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 150) && c.playerLevel[c.playerSummoning] >= 85) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(23700, c.playerSummoning);
                        //c.sendMessage("You created ; Swamp Titan Pouch");
                        c.deleteItem(10149, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 150);
                        c.deleteItem(BCHARM, 1);
                        c.addItem(12776, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 93232: //Rune minotaur pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(BCHARM, 1) && c.playerHasItem(2363, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 111) && c.playerLevel[c.playerSummoning] >= 86) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(24100, c.playerSummoning);
            ...
            case 93240: //Unicorn stallion pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(GRCHARM, 1) && c.playerHasItem(237, 1) && c.playerHasItem(POUCH, 1) && c.playerHasItem(SHARD, 140) && c.playerLevel[c.playerSummoning] >= 88) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(22900, c.playerSummoning);
            ...
            case 93248: //Geyser Titan Pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(BCHARM, 1) && c.playerHasItem(1444, 1) && c.playerHasItem(12155, 1) && c.playerHasItem(18016, 222) && c.playerLevel[c.playerSummoning] >= 89) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(26900, c.playerSummoning);
                        //c.sendMessage("You created ; Geyser Titan Pouch");
                        c.deleteItem(1444, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 222);
                        c.deleteItem(BCHARM, 1);
                        c.addItem(12786, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 94000: //Wolpertinger Pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(CCHARM, 1) && c.playerHasItem(3226, 1) && c.playerHasItem(12155, 1) && c.playerHasItem(18016, 203) && c.playerLevel[c.playerSummoning] >= 92) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(25900, c.playerSummoning);
                        //c.sendMessage("You created ; Wolpertinger Pouch");
                        c.deleteItem(3226, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 203);
                        c.deleteItem(CCHARM, 1);
                        c.addItem(12089, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 94008: // abyssal Titan Pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(GRCHARM, 1) && c.playerHasItem(12161, 1) && c.playerHasItem(12155, 1) && c.playerHasItem(18016, 113) && c.playerLevel[c.playerSummoning] >= 93) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(24900, c.playerSummoning);
                        //c.sendMessage("You created ; Abyssal Titan Pouch");
                        c.deleteItem(12161, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 113);
                        c.deleteItem(GRCHARM, 1);
                        c.addItem(12796, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 94016: // Iron Titan Pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(CCHARM, 1) && c.playerHasItem(1115, 1) && c.playerHasItem(12155, 1) && c.playerHasItem(18016, 198) && c.playerLevel[c.playerSummoning] >= 95) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(26300, c.playerSummoning);
            ...
            case 94024: // Pack Yak Pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(CCHARM, 1) && c.playerHasItem(10818, 1) && c.playerHasItem(12155, 1) && c.playerHasItem(18016, 211) && c.playerLevel[c.playerSummoning] >= 96) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(40900, c.playerSummoning);
                        //c.sendMessage("You created ; Pack Yak Pouch");
                        c.deleteItem(10818, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 211);
                        c.deleteItem(CCHARM, 1);
                        c.addItem(12093, 1);
                    } else {
                        if (c.hasSentMessage) {
            ...
            case 94032: // Steel Titan Pouch
                c.hasSentMessage = false;
                for (int i = 0; i < summoningPouchData.length; i++) {
                    if (c.playerHasItem(BCHARM, 1) && c.playerHasItem(1119, 1) && c.playerHasItem(12155, 1) && c.playerHasItem(18016, 178) && c.playerLevel[c.playerSummoning] >= 99) {
                        //c.closeAllWindows();
                        c.gfx0(2128);
                        c.addSkillXP(50900, c.playerSummoning);
                        //c.sendMessage("You created ; Steel Titan Pouch");
                        c.deleteItem(1119, 1);
                        c.deleteItem(POUCH, 1);
                        c.deleteItem(SHARD, 178);
                        c.deleteItem(BCHARM, 1);
                        c.addItem(12790, 1);
                    } else {
                        if (c.hasSentMessage) {
