class SmithingInterface(var c: client) {
    ...
    private fun makeAddyInterface(c: client) {
        ...
        c
            .getPA().sendFrame126(GetForlvl(71, c) + "Axe" + GetForlvl(1, c), 1091)
    ...
    private fun makeMithInterface(c: client) {
        ...
        c
            .getPA().sendFrame126(GetForlvl(51, c) + "Axe" + GetForlvl(1, c), 1091)
    ...
    private fun makeSteelInterface(c: client) {
        ...
        c
            .getPA().sendFrame126(GetForlvl(31, c) + "Axe" + GetForlvl(1, c), 1091)
        c.getPA().sendFrame126(
    ...
    private fun makeIronInterface(c: client) {
        ...
        c
            .getPA().sendFrame126(GetForlvl(16, c) + "Axe" + GetForlvl(1, c), 1091)
    ...
    private fun makeBronzeInterface(c: client) {
        ...
        c
            .getPA().sendFrame126(GetForlvl(2, c) + "Mace" + GetForlvl(2, c), 1093)
        c.getPA().sendFrame126(
