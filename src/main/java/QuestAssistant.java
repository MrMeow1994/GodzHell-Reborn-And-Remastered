public class QuestAssistant {
    ...
    public static void sendStages(client player) {
        player.getPA().sendFrame126("QP: " + player.questPoints + " ", 3985);
        ...
        if (player.lostCity == 0) {
            player.getPA().sendFrame126("Lost City", 7367);
        } else if (player.lostCity == 3) {
            player.getPA().sendFrame126("@gre@Lost City", 7367);
        } else {
    ...
    public static void questButtons(client player, int buttonId) {
        switch (buttonId) {
