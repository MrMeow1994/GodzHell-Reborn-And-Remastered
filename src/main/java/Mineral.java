...
public enum Mineral {
    ...
    CLAY_BIG_3(new int[] { 11189 }, 11552,-1,"none", 1, 18, 0, 3, 15, 30000, true, generateExclusive(434)),
    CLAY_SMALL_3(new int[] { 11190 }, 11553,-1,"none", 1, 18, 0, 3, 15, 30000, true, generateExclusive(434)),
    CLAY_MID_3(new int[] { 11191 }, 11554,-1,"none", 1, 18, 0, 3, 15, 30000, true, generateExclusive(434)),
    CLAY_BIG_4(new int[] { 5766 }, 5763,-1,"none", 1, 18, 0, 3, 15, 30000, true, generateExclusive(434)),
    CLAY_SMALL_4(new int[] { 5767 }, 5764,-1,"none", 1, 18, 0, 3, 15, 30000, true, generateExclusive(434)),
    ...
    COPPER_BIG_7(new int[] { 11936 }, 11552,-1,"bronze", 1, 18, 5, 5, 15, 15000, true, generateExclusive(436)),
    COPPER_SMALL_7(new int[] { 11937 }, 11553,-1,"bronze", 1, 18, 5, 5, 15, 15000, true, generateExclusive(436)),
    COPPER_MID_7(new int[] { 11938 }, 11554,-1,"bronze", 1, 18, 5, 5, 15, 15000, true, generateExclusive(436)),
    ...
    TIN_BIG_7(new int[] { 11933 }, 11552,-1,"bronze", 1, 18, 5, 5, 15, 15000, true, generateExclusive(438)),
    TIN_SMALL_7(new int[] { 11934 }, 11553,-1,"bronze", 1, 18, 5, 5, 15, 15000, true, generateExclusive(438)),
    TIN_MID_7(new int[] { 11935 }, 11554,-1,"bronze", 1, 18, 5, 5, 15, 15000, true, generateExclusive(438)),
    ...
    IRON_BIG_8(new int[] { 37307 }, 11552,-1,"iron", 15, 35, 5, 8, 17, 14800, true, generateExclusive(440)),
    IRON_SMALL_8(new int[] { 37308 }, 11553,-1,"iron", 15, 35, 5, 8, 17, 14800, true, generateExclusive(440)),
    IRON_MID_8(new int[] { 37309 }, 11554,-1,"iron", 15, 35, 5, 8, 17, 14800, true, generateExclusive(440)),
    ...
    SILVER_BIG_3(new int[] { 32444 },33400, -1,"silver", 20, 40, 5, 8, 17, 14800, true, generateExclusive(442)),
    SILVER_SMALL_3(new int[] { 32445 },33401, -1,"silver", 20, 40, 5, 8, 17, 14800, true, generateExclusive(442)),
    SILVER_MID_3(new int[] { 32446 },33402, -1,"silver", 20, 40, 5, 8, 17, 14800, true, generateExclusive(442)),
    SILVER_BIG_4(new int[] { 37304 },11552, -1,"silver", 20, 40, 5, 8, 17, 14800, true, generateExclusive(442)),
    SILVER_SMALL_4(new int[] { 37305 },11553, -1,"silver", 20, 40, 5, 8, 17, 14800, true, generateExclusive(442)),
    SILVER_MID_4(new int[] { 37306 },11554, -1,"silver", 20, 40, 5, 8, 17, 14800, true, generateExclusive(442)),
    SILVER_BIG_5(new int[] { 11186 },11552, -1,"silver", 20, 40, 5, 8, 17, 14800, true, generateExclusive(442)),
    SILVER_SMALL_5(new int[] { 11187 },11553, -1,"silver", 20, 40, 5, 8, 17, 14800, true, generateExclusive(442)),
    SILVER_MID_5(new int[] { 11188 },11554, -1,"silver", 20, 40, 5, 8, 17, 14800, true, generateExclusive(442)),
    ...
    GOLD_BIG_8(new int[] { 11183 }, 11552, -1,"gold", 40, 65, 3, 25, 32, 14200, true, generateExclusive(444)),
    GOLD_SMALL_8(new int[] { 11184 }, 11553, -1,"gold", 40, 65, 3, 25, 32, 14200, true, generateExclusive(444)),
    GOLD_MID_8(new int[] { 11185 }, 11554, -1,"gold", 40, 65, 3, 25, 32, 14200, true, generateExclusive(444)),
    ...
    MITHRIL_BIG_8(new int[] { 11942 }, 11552, -1, "mithril", 55, 80, 3, 40, 35, 13800, true, generateExclusive(447)),
    MITHRIL_SMALL_8(new int[] { 11943 }, 11553, -1,"mithril", 55, 80, 3, 40, 35, 13800, true, generateExclusive(447)),
    MITHRIL_MID_8(new int[] { 11944 }, 11554, -1,"mithril", 55, 80, 3, 40, 35, 13800, true, generateExclusive(447)),
    ...
    ADAMANT_BIG_4(new int[] { 11939 }, 11552, -1,"adamant", 70, 95, 2, 50, 37, 13200, true, generateExclusive(449)),
    ADAMANT_MID_4(new int[] { 11941 }, 11554, -1,"adamant", 70, 95, 2, 50, 37, 13200, true, generateExclusive(449)),
